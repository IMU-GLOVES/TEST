...
void setup() {
  ...
  Wire.begin();         // I2C 初始化
  Wire.setClock(100000); // 開啟 400kHz I2C 極速模式 (很重要，不然讀不完)
  ...
  // --- [目前硬體配置] ---
  // 多功器 A (0x70)
  imus[0] = new MPU6050_Node(MUX_ADDR_A, 0); // 無名指指尖 (Ch0)
  imus[1] = new MPU6050_Node(MUX_ADDR_A, 1); // 無名指指中 (Ch1)
  imus[2] = new MPU6050_Node(MUX_ADDR_A, 2); // 無名指指根 (Ch2)

  imus[3] = new MPU6050_Node(MUX_ADDR_A, 3); // 小指尖 (Ch3)
  imus[4] = new MPU6050_Node(MUX_ADDR_A, 4); // 小指中 (Ch4)
  imus[5] = new MPU6050_Node(MUX_ADDR_A, 5); // 小指根 (Ch5)
  ...
  imus[6] = new MPU9250_Node(MUX_ADDR_A, 7); // 掌心 (接 SD7)
