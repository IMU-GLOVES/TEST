...
# ==== Madgwick 初始化 ====
madgwick1 = Madgwick(beta=0.3)  # beta=0.001
...
# 在更新 Madgwick 之前
def apply_deadzone(gyr, threshold=0.01):
    gyr[abs(gyr) < threshold] = 0
    return gyr

# ==== 1210 add: 每一節的角度校正參數（之後你可以手動調整）====
flex_gain1 = 4   # base 節 angle scale 7
flex_gain2 = 4   # middle 節 angle scale 6
flex_gain3 = 4   # tip 節 angle scale 5
